...
| 3 | [Securing your agent](03-securing-your-agent.md) | Pick the right auth mode (none / bearer / mTLS / Unix socket) and whether to add plain TLS, for your deployment |
